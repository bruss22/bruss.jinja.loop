...
- main.j2 contains list of dictionaries key:value,  values are metavars in fortimanager<br>
- main is imported into build scripts.<br>
...
- build scripts loop through list building interfaces only if name:*_name metavar is defined for device<br>
